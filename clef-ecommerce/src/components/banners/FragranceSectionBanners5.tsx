...
const FragranceSectionBanners5: React.FC = () => {
    return (
    ...
    <div className="w-full bg-coolPink-400 rounded-xl relative py-12 px-8 overflow-hidden">
      ...
      <div className="relative z-50">
        <div className="flex flex-col justify-center items-center max-w-4xl mx-auto">
          <div className="py-1 px-3 bg-white rounded-xl uppercase text-xs text-rhino-700 font-bold tracking-widest mb-6 mx-auto">Watch Now!</div>
          <h1 className="text-rhino-800 font-heading text-4xl sm:text-5xl font-semibold mb-2 text-center">Live a little and your life will come alive</h1>
          <p className="text-rhino-700 mb-8 text-center">CLEF Fragrance is a collection of fine fragrances that awaken your sense of ritual.</p>
