...
const LoginSectionSignIn1: React.FC<LoginSectionSignIn1Props> = ({ onForgotPassword }) => {
    return (
        <section className="overflow-hidden py-12 relative">
  <img className="absolute bottom-0 left-0 bg-opacity-50 w-full h-full" src="/coleos-assets/sign-in/bg-gradient2.png" alt="" />
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap relative -mx-4 z-50">
      <div className="w-full lg:w-1/2 p-4">
        <div className="bg-rhino-900 px-4 md:px-8 py-10 rounded-lg">
          <form>
            <h2 className="text-white text-2xl font-semibold mb-8 font-heading">Login</h2>
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput1">E-Mail Address</label>
            ...
            <div className="flex flex-col gap-1 mb-8">
              <label className="text-white text-sm font-medium" htmlFor="textInput2">Password</label>
              <div className="py-3 px-4 rounded-sm border border-coolGray-200 flex w-full bg-white">
                <input className="block w-full flex-1 outline-none" id="textInput2" type="text" placeholder="Password" />
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <label className="block text-white text-sm" htmlFor="checkbox1">By using this form you agree with the storage and handling of your data by this website.</label>
            </div>
            <div className="flex justify-between flex-wrap gap-4">
              <a className="py-3 px-4 bg-purple-500 rounded-sm text-sm text-white font-medium hover:bg-purple-600 transition duration-200 clef-button-primary" href="#">Login</a>
              <button className="py-3 px-4 bg-white rounded-sm text-sm text-coolGray-700 font-medium hover:bg-purple-500 hover:text-white transition duration-200 shadow-md clef-button-primary" type="button" onClick={onForgotPassword}>Forgot password?</button>
            </div>
          </form>
        </div>
      </div>
      <div className="w-full lg:w-1/2 p-4">
        <div className="bg-rhino-900 px-4 md:px-8 py-10 rounded-lg">
          <form>
            <h2 className="text-white text-2xl font-semibold mb-8 font-heading">Register</h2>
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput3">First Name</label>
            ...
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput4">Last Name</label>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <label className="block text-white text-sm" htmlFor="checkbox2">Sign up for newsletter</label>
            </div>
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput5">E-Mail Address</label>
            ...
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput6">Password</label>
            ...
            <div className="flex flex-col gap-1 mb-4">
              <label className="text-white text-sm font-medium" htmlFor="textInput7">Confirm password</label>
              <div className="py-3 px-4 rounded-sm border border-coolGray-200 flex bg-white">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <label className="block text-white text-sm" htmlFor="checkbox3">By using this form you agree with the storage and handling of your data by this website.</label>
            </div>
            <a className="w-full block text-center py-3 px-4 bg-purple-500 rounded-sm text-sm text-white font-medium hover:bg-purple-600 transition duration-200 clef-button-primary" href="#">Create Account</a>
          </form>
        </div>
      </div>
    </div>
