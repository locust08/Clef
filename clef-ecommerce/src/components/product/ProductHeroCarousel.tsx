              ...
              >
                <div className="flex flex-col justify-center px-8 py-12 sm:px-16 lg:px-24">
                  ...
                  <a className="clef-link-highlight" href={slide.href}>
                    <h2 className="mb-4 font-heading text-3xl font-semibold leading-tight text-rhino-800 sm:text-4xl lg:text-5xl">
                      {slide.title}
                    </h2>
                  </a>
                  <p className="mb-6 max-w-xl text-sm font-medium leading-7 text-rhino-400">
                    {slide.description}
                  </p>
                  {slide.priceDisplay ? (
                    <p className="mb-8 font-heading text-3xl font-semibold text-rhino-800 sm:text-4xl">
                      {slide.priceDisplay}
                    </p>
                  ) : null}
                  <a
                    className="inline-flex w-fit rounded-sm bg-purple-500 px-5 py-3 text-center text-sm font-medium text-white transition duration-200 hover:bg-purple-600 clef-button-primary"
                    href={slide.href}
                  >
                    {slide.ctaLabel}
                  </a>
